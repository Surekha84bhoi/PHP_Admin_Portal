...
//  //*=all
// $dm="SELECT * FROM data"; 
// $data=mysqli_query($conn, $dm);

// $total=mysqli_num_rows($data);  //for knowing how much rows are present in table
// //echo $total ;

// $sb = mysqli_fetch_asso($data)     //for fetching data  //it works in form of array
//     //echo $result;
// if($total !=0)
// {
